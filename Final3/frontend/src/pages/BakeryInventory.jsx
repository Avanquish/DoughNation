...
export default function BakeryInventory({ isViewOnly = false }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.expiration_date && currentServerDate) {
      ...
      if (thresholdDate < today) {
        const daysFromToday = Math.ceil((expDate - today) / (1000 * 60 * 60 * 24));
  ...
  const handleUpdate = async (e) => {
    ...
    if (!selectedItem.image_file && !selectedItem.template_image && !selectedItem.image) {
      Swal.fire({
        title: "Image Required",
        text: "Please upload a product image.",
        icon: "error",
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="p-2">
        <div>
          <h2 className="text-3xl font-extrabold text-[#6b4b2b]">List of Product for Donation</h2>
          <p className="mt-1 text-sm text-[#7b5836]">List of Products</p>
        </div>
      </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={(() => {
                          if (!form.expiration_date || !currentServerDate) return "Set expiration date first";
                          ...
                          // If threshold is before today, use today instead
                          if (thresholdDate < today) {
                ...
                <>
                  ...
                  <button
                    onClick={() => {
                      ...
                      if (selectedItem.status && selectedItem.status.toLowerCase() === "donated") {
                        Swal.fire({
                          title: "Cannot Edit",
                    ...
                    className={pillSolid}
                    title={
                      selectedItem.status && selectedItem.status.toLowerCase() === "donated"
          ...
          <form onSubmit={handleUpdate} className="h-full flex flex-col">
            ...
            <div className="flex-1 p-5 space-y-4 overflow-y-auto">
             ...
             <div>
                ...
                {!selectedItem.image && !selectedItem.template_image && !selectedItem.image_file && (
                  <p className="mt-1 text-xs text-red-600">
                    Product image is required
                  </p>
                )}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`${inputTone} rounded-2xl bg-gray-100 cursor-not-allowed`}
                    value={(() => {
                      if (!selectedItem.expiration_date || !currentServerDate) return "Set expiration date first";
                ...
                <div>
                  ...
                  <input
                    ...
                    max={currentServerDate}
                    className={`${inputTone} rounded-2xl`}
                    value={selectedItem.creation_date ? selectedItem.creation_date.split("T")[0] : ""}
                    onChange={(e) =>
                      setSelectedItem({
                        ...selectedItem,
