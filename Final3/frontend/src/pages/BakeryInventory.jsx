            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  min="0"
                  className={`${inputTone} rounded-2xl [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ${
                    templateInfo || !selectedItem.expiration_date || !selectedItem.expiration_date ? 'bg-gray-100 cursor-not-allowed' : ''
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`${inputTone} rounded-2xl ${
                    !isNameModified || templateInfo ? 'bg-gray-100 cursor-not-allowed' : ''
                  }`}
