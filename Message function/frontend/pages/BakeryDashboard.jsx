...
import BakeryNotification from "../Bakery_Components/BakeryNotification";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-3">
             ...
             <BakeryNotification />
             <Messages currentUser={currentUser} setActiveTab={setActiveTab} setHighlightedDonationId={setHighlightedDonationId}/>
