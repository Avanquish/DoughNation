      ...
      >
        ...
        <section className="mt-8 grid gap-6 md:grid-cols-2">
          ...
          <div className="glass rounded-2xl card-pad">
            ...
            >
              For account issues, data concerns, or urgent platform matters,
              contact our DoughNation administrator:
            </p>
            <div className="mt-4">
              ...
              <a
                ...
                className="mt-1 inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium btn-shimmer text-white hover:shadow-lg hover:shadow-amber-300/30 transition-transform active:scale-[.98]"
          ...
          <div className="glass rounded-2xl card-pad">
            ...
            <p
              ...
              style={{ color: "var(--coffee2)", fontSize: "var(--text)" }}
            >
              You can also reach our development team for feedback, feature
              requests, or technical questions.
            </p>
            <ul className="mt-4 space-y-3" style={{ fontSize: "var(--text)" }}>
              <li>
                <p className="font-medium" style={{ color: "var(--coffee)" }}>
