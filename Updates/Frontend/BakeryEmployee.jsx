...
// Build full URL for image paths
const toUrl = (p) => {
  if (!p) return null;
...
// Pick the best available image field from employee object
...
const BakeryEmployee = () => {
  ...
  // Lock scroll while verify overlay is open
  useEffect(() => {
    const showVerify = employees.length > 0 && !verified;
    if (!showVerify) return;
    const prev = document.body.style.overflow;
    document.body.style.overflow = "hidden";
    return () => (document.body.style.overflow = prev);
  }, [employees.length, verified]);
  ...
  const openEdit = (emp) => {
    ...
    setFormData({
      name: emp?.name || "",
      role: emp?.role || "Full Time Staff",
      start_date: emp?.start_date || "",
      profile_image_file: null,
    });
    setPreview(toUrl(pickEmployeeImage(emp)));
    setIsDialogOpen(true);
  };
      ...
      <div className="gwrap hover-lift reveal r1">
        <div className="glass-card p-5 rounded-[15px] shadow-none border border-white/70">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <h2 className="text-2xl font-bold text-[#6b4b2b]">
                Employee Management
              </h2>
      ...
      {employees.length > 0 && !verified && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md">
            <div className="mx-auto bg-white rounded-2xl shadow-2xl ring-1 ring-black/10 overflow-hidden w-full">
              <div className="p-5 sm:p-6 border-b bg-gradient-to-r from-[#FFF3E6] via-[#FFE1BD] to-[#FFD199]">
                <h3 className="text-lg font-semibold text-[#6b4b2b] text-center">
                  Verify Access
                </h3>
              </div>
              ...
              <div className="p-5 sm:p-6">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-[#f2d4b5] bg-white/95 p-2 outline-none shadow-sm focus:ring-2 focus:ring-[#E49A52] focus:border-[#E49A52]"
                  />
                ...
                <div className="mt-5 flex justify-end">
                  <button
                    ...
                    className="rounded-full bg-gradient-to-r from-[#F6C17C] via-[#E49A52] to-[#BF7327] text-white px-5 py-2 shadow-md ring-1 ring-white/60 transition-transform duration-150 hover:-translate-y-0.5 active:scale-95"
                  >
                    Manage Employees
                  </button>
                </div>
          ...
          {employees.length ? (
            ...
            <div className="gwrap reveal hover-lift col-span-full">
              <div className="glass-card rounded-[15px] p-6 border border-white/70 text-center">
                <p className="text-gray-600">No employees found. Please add one.</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="space-y-4">
            ...
            >
              ...
              <SelectContent className="bg-white text-black">
                <SelectItem value="Part Time Staff" className="hover:bg-gray-100">
                  Part Time Staff
                </SelectItem>
                <SelectItem value="Full Time Staff" className="hover:bg-gray-100">
                  Full Time Staff
                </SelectItem>
                <SelectItem value="Manager" className="hover:bg-gray-100">
                  Manager
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} className="btn-logout">
              Save
            </Button>
          </DialogFooter>
        </DialogContent>
