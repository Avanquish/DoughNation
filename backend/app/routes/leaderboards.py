...
def get_bakery_leaderboard(
    ...
    direct_donations = (
        ...
        .join(models.DonorInventory, models.DirectDonation.bakery_inventory_id == models.DonorInventory.id)
        .join(models.User, models.DonorInventory.bakery_id == models.User.id)
        .filter(models.DirectDonation.btracking_status == "complete")
        .filter(models.User.role == "Donor")
