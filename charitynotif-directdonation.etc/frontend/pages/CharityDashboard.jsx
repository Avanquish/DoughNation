...
import CharityDonation from "../pages/CharityDonation.jsx";
import Messages from "../pages/Messages.jsx";
import CharityReceived from "../pages/CharityReceived.jsx";
import CharityNotification from "../Bakery_Components/CharityNotification.jsx"; //addition: import the frontend file.
...
//ADDITION
  ...
  return () => window.removeEventListener("switch_to_donation_tab", handleSwitch);
}, []);
...
//Switch to received tab 
  ...
  return () => window.removeEventListener("switch_to_received_tab", handleSwitch);
}, []);
