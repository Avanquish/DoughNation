...
const AdminDashboard = () => {
  ...
  // Header chip text that follows the active tab
...
.header-skin::after{
  ...
  animation:dotsDrift 36s linear infinite; opacity:.33; mix-blend-mode:multiply;
...
.brand-pop{
  ...
  animation:brandShimmer 6s ease-in-out infinite; letter-spacing:.2px;
}
...
.head-bg{position:absolute; inset:0; z-index:-1; opacity:.95; background:linear-gradient(110deg,#ffffff 0%, #fff7ef 28%, #ffeddc 55%, #ffe6cf 100%); background-size:220% 100%; animation: headerSlide 18s linear infinite;}
...
.status-chip{display:inline-flex; align-items:center; gap:.5rem; margin-top:.15rem; padding:.28rem .6rem; font-size:.78rem; font-weight:800; border-radius:9999px; color:#7a4f1c; background:linear-gradient(180deg,#FFE7C5,#F7C489); border:1px solid #fff3e0}
...
.chip{width:46px; height:46px; display:flex; align-items:center; justify-content:center; border-radius:9999px; background:linear-gradient(180deg,#FFE7C5,#F7C489); color:#8a5a25; border:1px solid #fff3e0; box-shadow:0 6px 18px rgba(201,124,44,.16)}
...
@keyframes bell-bounce{0%{transform:translateY(0)}30%{transform:translateY(-3px)}60%{transform:translateY(0)}80%{transform:translateY(-1.5px)}100%{transform:translateY(0)}}
...
.stat::before{content:""; position:absolute; inset:0; border-radius:16px; background:linear-gradient(135deg, rgba(247,199,137,.9), rgba(201,124,44,.45)); opacity:.9; filter:saturate(1.02);}
.stat-inner{position:relative; border-radius:15px; background:rgba(255,255,255,.94); backdrop-filter:blur(8px); height:120px; display:flex; align-items:center; justify-content:space-between; padding:1rem 1.25rem; box-shadow:0 10px 24px rgba(201,124,44,.10); transition: box-shadow .25s cubic-bezier(.22,.98,.4,1), transform .25s cubic-bezier(.22,.98,.4,1);}
...
.stat-ico{width:54px; height:54px; display:grid; place-items:center; border-radius:9999px; background:radial-gradient(120% 120% at 30% 25%, #ffe6c6 0%, #f7c489 55%, #e8a765 100%); box-shadow:0 10px 24px rgba(201,124,44,.20), inset 0 1px 0 rgba(255,255,255,.8); border:1px solid rgba(255,255,255,.8)}
.stat-ico svg{width:22px; height:22px; color:#8a5a25}

.icon-btn{position:relative; display:inline-flex; align-items:center; justify-content:center; width:42px; height:42px; border-radius:9999px; background:rgba(255,255,255,.9); border:1px solid rgba(0,0,0,.06); box-shadow:0 6px 16px rgba(201,124,44,.14); transition:transform .18s ease, box-shadow .18s ease}
.icon-btn:hover{transform:translateY(-1px); box-shadow:0 10px 22px rgba(201,124,44,.20)}
.icon-btn:hover svg, .icon-btn .bell-icon{animation:none !important; transform:none !important;}

.user-action-bg{background: radial-gradient(120% 120% at 30% 25%, #ffe6c6 0%, #f7c489 55%, #e8a765 100%); box-shadow: 0 10px 24px rgba(201, 124, 44, .20), inset 0 1px 0 rgba(255, 255, 255, .8);}
                    ...
                    <div className="p-2 pt-4 sm:p-4 md:p-6">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-[#7b5836]">
                          Track top performers by donations
                        </p>
                      </div>
                    </div>
                  </div>
