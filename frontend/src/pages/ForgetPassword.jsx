...
const ForgotPassword = () => {
    ...
    try {
      const endpoint =
        accountType === "employee"
          ? "https://api.doughnationhq.cloud/employee/forgot-password/send-otp"
          : "https://api.doughnationhq.cloud/forgot-password/send-otp";
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const endpoint =
        accountType === "employee"
          ? "https://api.doughnationhq.cloud/employee/forgot-password/verify-otp"
          : "https://api.doughnationhq.cloud/forgot-password/verify-otp";
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const endpoint =
        accountType === "employee"
          ? "https://api.doughnationhq.cloud/employee/forgot-password/reset-with-otp"
          : "https://api.doughnationhq.cloud/forgot-password/reset-with-otp";
