      ...
      if (accountType === "employee") {
        ...
        if (accountType === "bakery") {
          ...
          if (decoded.must_change_password) {
            Swal.fire({
              icon: "warning",
              title: "One-Time Password Detected",
              html: `
                <div class="text-left">
                  <p class="mb-3">For security reasons, you must change your one-time password before accessing the system.</p>
                  <div class="bg-amber-50 border border-amber-200 rounded-lg p-3">
                    <p class="text-sm text-amber-800 font-semibold mb-2">🔐 Why?</p>
                    <ul class="text-sm text-amber-700 space-y-1">
                      <li>• This password was generated by an administrator</li>
                      <li>• It's a temporary password for security</li>
                      <li>• You need to create your own secure password</li>
                    </ul>
                  </div>
                </div>
              `,
            ...
            // Redirect to one-time password change page
            setTimeout(() => {
              navigate("/one-time-password-change");
            }, 2000);
            return;
          }
          ...
          // 🔐 CHECK IF USER MUST CHANGE ONE-TIME PASSWORD (Ownership Transfer/Emergency Reset)
          if (decoded.must_change_password) {
            Swal.fire({
              icon: "warning",
              title: "One-Time Password Detected",
